...
const int ZER_EXT_DEVICE_INFO_CUDA_ASYNC_BARRIER = ZER_EXT_DEVICE_INFO_END - 15;
const int ZER_EXT_DEVICE_INFO_BACKEND_VERSION = ZER_EXT_DEVICE_INFO_END - 16;
const int ZER_EXT_DEVICE_INFO_IMAGE_MAX_ARRAY_SIZE =
    ZER_DEVICE_INFO_IMAGE_MAX_ARRAR_SIZE;

const int ZER_EXT_CONTEXT_INFO_END = ZER_CONTEXT_INFO_FORCE_UINT32;
const int ZER_EXT_CONTEXT_INFO_REFERENCE_COUNT = ZER_EXT_CONTEXT_INFO_END - 1;
const int ZER_EXT_CONTEXT_INFO_ATOMIC_MEMORY_ORDER_CAPABILITIES = ZER_EXT_CONTEXT_INFO_END - 2;
const int ZER_EXT_CONTEXT_INFO_ATOMIC_MEMORY_SCOPE_CAPABILITIES = ZER_EXT_CONTEXT_INFO_END - 3;
const int ZER_EXT_CONTEXT_INFO_USM_MEMCPY2D_SUPPORT = ZER_EXT_CONTEXT_INFO_END - 4;
const int ZER_EXT_CONTEXT_INFO_USM_FILL2D_SUPPORT = ZER_EXT_CONTEXT_INFO_END - 5;
const int ZER_EXT_CONTEXT_INFO_USM_MEMSET2D_SUPPORT = ZER_EXT_CONTEXT_INFO_END - 6;
