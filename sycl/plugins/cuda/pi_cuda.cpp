...
pi_uint64 _pi_event::get_queued_time() const {
  ...
  PI_CHECK_ERROR(
      cuEventElapsedTime(&miliSeconds, _ur_platform_handle_t::evBase_, evQueued_));
...
pi_uint64 _pi_event::get_start_time() const {
  ...
  PI_CHECK_ERROR(
      cuEventElapsedTime(&miliSeconds, _ur_platform_handle_t::evBase_, evStart_));
  return static_cast<pi_uint64>(miliSeconds * 1.0e6);
}
...
pi_uint64 _pi_event::get_end_time() const {
  ...
  PI_CHECK_ERROR(
      cuEventElapsedTime(&miliSeconds, _ur_platform_handle_t::evBase_, evEnd_));
  return static_cast<pi_uint64>(miliSeconds * 1.0e6);
}
...
pi_result cuda_piextDeviceCreateWithNativeHandle(pi_native_handle nativeHandle,
  ...
  auto is_device = [=](std::unique_ptr<_ur_device_handle_t> &dev) {
...
pi_result cuda_piGetDeviceAndHostTimer(pi_device Device, uint64_t *DeviceTime,
  ...
  if (DeviceTime) {
    ...
    PI_CHECK_ERROR(
        cuEventElapsedTime(&elapsedTime, _ur_platform_handle_t::evBase_, event));
